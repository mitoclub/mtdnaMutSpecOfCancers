---
title: "Mitochondial mutational spectrum of cancer as a function of position, tissue and VAF"
...
#### 3. Derive TBSS for each position, positions within D-loop and Ol will have NA
***
```{r}
Mut$TBSS = NA
for (i in 1:nrow(Mut))
...
### 5. univariate analyses: DummyAhGh ~ TBSS(NA), DummyAhGh ~ + TurnOverDays(*), DummyAhGh ~ + tumor_var_freq(***)
***
```{r}
...
### 6. multivariate backward stepwise logistic regression: DummyAhGh ~ TBSS + TurnOverDays + tumor_var_freq
***
```{r}
